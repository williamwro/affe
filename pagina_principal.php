                                ...
                                <form name="busca_associado" id="busca_associado" method="post" action="#">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 280px;border: 0;padding-bottom: 0px;">
                                            <input name="cod_carteira" id="cod_carteira" type="text" class="form-control" style="font-weight: bold; font-size: 17px; text-align: center; font-family: 'Arial Black' "/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 40px;height: 60px;border: 0;padding-bottom: 0px;">
                                            <input type="text"   id="valor_pedido"        name="valor_pedido"        value="<?PHP echo $valor_pedido;?>" class="form-control" maxlength="8" />
                                ...
                                <table class="table" id="via1" style="margin-bottom: -4px;
                                    ...
                                    <tr>
                                        <td style=" width: 30px;
                                                                ...
                                                                padding-right: 4px;">
                                            <img src="logomini.png" style="max-width: 60px;max-height: 40px;" alt="">
                                        </td>
                                        <td style="font-size: 14px;
                                                               ...
                                                               padding: 0;
                                                               padding-bottom: 6px;
                                                               border-bottom: 1px solid #bdbdbd;">Affe Tecnologia</td>
